(function installV142HistoryAudit(global){
  ...
  const VERSION='2026-09-02-v419-low-priority-history-audit-no-open-mutation-v2';
  ...
  function statusPriorityBusy(){
    ...
    if(owner&&!owner.lastTruth)return true;
