(function installRouteLazyFeaturesV108(global){
  if(global.__CE_QC_V108_ROUTE_LAZY__?.version==='2026-08-21-qc11-all-export-route-lazy-v1')return;
  const VERSION='2026-08-21-qc11-all-export-route-lazy-v1';
  ...
  const groups={
    ...
    reports:['/v190-export-direct-route-client.js?v=20260818-v191-1','/v84-async-export-ui.js?v=20260818-v193-1','/v194-export-token-ui.js?v=20260821-qc11-1'],
  ...
  function loadScript(src){
    ...
    const promise=new Promise((resolve,reject)=>{
      const script=document.createElement('script');script.src=src;script.async=false;script.dataset.ceQcLazy='qc11';
