(function installV473AllExportSidecarUi(global){
  ...
  const VERSION='2026-09-08-v473-all-export-sidecar-ui-v1';
  ...
  function targets(){return {progress:document.getElementById('exportProgressV193')||document.getElementById('exportProgressV192')||document.getElementById('exportProgress'),files:document.getElementById('exportGeneratedFilesV193')||document.getElementById('exportGeneratedFilesV192')||document.getElementById('exportGeneratedFiles')};}
  ...
  global.__CE_QC_V473_EXPORT_UI__={version:VERSION,sidecarVersion:SIDECAR_VERSION,sidecarOrigin,claim,startExport};
