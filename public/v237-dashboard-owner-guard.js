(function installV237DashboardOwnerGuard(global){
  ...
  const VERSION='2026-08-22-v237-dashboard-owner-guard-v2';
  ...
  global.fetch=function v237OwnedFetch(input,init){
    ...
    if(isOwnedPage()&&(global.__CE_QC_V237_DASHBOARD_OWNER__||global.__CE_QC_V234_DASHBOARD_LIVE__)){
      // V232 legacy trend UI is retired on owned dashboards. V237 reads the
      // same dates through /api/v234/trends and owns the charts/table.
  ...
  console.info('[CE-QC][V237_DASHBOARD_OWNER_GUARD]',VERSION,'legacy trend panel + passive reconciliation reads retired on homepage/business dashboards');
})(window);
