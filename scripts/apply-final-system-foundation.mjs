...
patchFile('src/rangeDashboardStoreV31.js', [
  {
    label: 'CCSL normal operational count',
  ...
  {
    label: 'Shopee normal operational count',
    before: `      SUM(CASE WHEN UPPER(COALESCE(f.primaryCategory,'')) IN ('SELF_PICKUP','CECN_RETENTION','CEZT_RETENTION','CCSL580_RETENTION')
  ...
  {
    label: 'CCSL state normal operational',
  ...
  {
    label: 'CCSL abnormal denominator final',
  ...
  {
    label: 'CCSL detail denominator final',
  ...
  {
    label: 'merge normal operational',
    before: `'returned','returnInProgress','normalShopOpen','specialClosed']`,
    after: `'returned','returnInProgress','normalShopOpen','normalOperationalOpen','specialClosed']`
  },
  {
    label: 'Shopee unresolved final',
