...
assert.match(indexHtml,/v581-stable-shell-owner\.js\?v=20260926-v587-1/,'V581 stable shell must ship in the normal dashboard HTML');
...
const stableAt=indexHtml.indexOf('/v581-stable-shell-owner.js?v=20260926-v587-1');
