...
import { readV322SevenBusinessStatus } from '../src/v322WebAvailabilityPatch.js';
import { readV415CurrentProcessingProof } from '../src/v415RetroactiveCompletionGuard.js';
...
console.log('[V424] same-lifecycle completion smoke passed · accidental later CCSL runId cannot hide a proven completion · current-member proof remains mandatory · newer VALID import boundary invalidates old completion even with identical shipment membership');
