...
for(const file of ['src/v485StrictTrackEvidence.js','src/v484StrictExportEvidenceOwner.js','src/v381ExportEvidenceRepair.js']){
...
console.log('[V485] nested CE track + V266 archive evidence smoke passed · parent shipment identity inherited · strict attempt/POD recovered · SQLite→archive→50x4 order locked · remote failure/event coverage diagnostics mandatory');
