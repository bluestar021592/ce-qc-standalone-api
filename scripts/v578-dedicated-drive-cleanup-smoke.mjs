...
assert.match(start,/\[CE-QC\]\[V593\] Unconditional sidebar coordinate routing \+ original visible menu \+ diff-aware updater gate/);
...
console.log('[V593] dedicated-drive cleanup smoke passed · obsolete CE_QC_RUNTIME backups on C are purged · live D database/user Documents/Downloads stay protected');
