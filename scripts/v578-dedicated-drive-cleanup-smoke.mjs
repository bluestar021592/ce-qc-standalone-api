...
assert.match(start,/\[CE-QC\]\[V580\] Blank-shell recovery \+ V579 C\/D cleanup/);
...
console.log('[V578/V579/V580] dedicated-drive cleanup smoke passed · PowerShell syntax parsed on Windows · C clears safe CE/user/browser caches + recycle bin · D owns update/runtime/npm scratch · no Documents/Downloads/system directories are blindly deleted');
