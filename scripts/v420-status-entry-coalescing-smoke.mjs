...
assert.match(shell,/<script src=\"\/v169-seven-business-legacy-status-sync\.js\?v=20260904-v421-1\"/,'browser shell must actually request the V421 entry bridge with a new cache-bust URL');
assert.match(shell,/<script src=\"\/v412-seven-business-convergence\.js\?v=20260904-v420-1\"/,'browser shell must actually request the V420 convergence build with a new cache-bust URL');
