...
assert.match(start,/\[CE-QC\]\[V578\] Dedicated C\/D storage cleanup \+ V575 click\/WHPP fixes are installed\./);
...
console.log('[V573/V575/V576/V577/V578] coordinate click recovery + WHPP homepage + non-blocking large-DB storage startup + dedicated-drive cleanup smoke passed');
