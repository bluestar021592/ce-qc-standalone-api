...
assert.match(whppStore, /existingDaily\.finalized && \(existingDaily\.identicalMembership \|\| explicitEmptyRehydrate\)/, 'only an exactly identical finalized membership or explicit empty rehydrate may preserve completion');
