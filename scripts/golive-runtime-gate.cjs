...
must(shell, '2026-08-17-v187-export-ui-exclusive-owner-shell-v1');
must(shell, '/v108-route-lazy-features.js?v=20260817-v187-1');
must(shell, '/v84-async-export-ui.js?v=20260817-v187-1');
...
must(asyncExportUi, 'exportProgressV187');
must(asyncExportUi, 'exportGeneratedFilesV187');
must(asyncExportUi, 'ceQcRetiredExportUi');
must(asyncExportUi, '[V187唯一进度]');
...
must(exportFastAck, '2026-08-17-v188-export-prepare-fast-ack-v2');
...
console.log('[GOLIVE] runtime-source gate passed; seven-business runner, queued V184 history refresh, isolated V185 one-pass Shopee export with V187 exclusive progress owner and V188 fast prepare ack, WHPP recovery and CCSL POD facts repair verified');
