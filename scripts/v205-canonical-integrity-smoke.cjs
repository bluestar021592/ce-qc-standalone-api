...
must(exporter,'ALL_COMPLETED_VALID_AND_SUPERSEDED_DAILY_IMPORTS_ARE_UNIONED');
...
must(shell,'/v205-data-integrity.js?v=20260818-v205-1');

console.log('[V205] canonical integrity smoke passed: completed historical snapshots remain in membership, exact business accepts family evidence, daily W/P no longer degrades to manual-review, and QC can visibly audit omissions and evidence coverage.');
