...
export const V329_THREE_BUSINESS_DAILY_CACHE_ID='2026-08-27-v334-three-business-history-first-attempt-v2';
...
function ensureColumns(db){
  ...
  if(!names.has('firstAttemptUnknownPod')){
    db.exec('ALTER TABLE v329_three_business_daily_cache ADD COLUMN firstAttemptUnknownPod INTEGER NOT NULL DEFAULT 0');
    db.exec('UPDATE v329_three_business_daily_cache SET firstAttemptUnknownPod=pod');
  }
}
