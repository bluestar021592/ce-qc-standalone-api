...
const PATCH_ID='2026-08-14-v114-responsive-performance-spine-v12';
...
let installed=false;
express.application.use=function v114WhppUiUse(...args){
...
export function inspectV114HtmlCache(){return {built:Boolean(injectedHtml),bytes:Buffer.byteLength(injectedHtml||'','utf8'),patchId:PATCH_ID};}
