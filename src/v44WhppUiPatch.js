...
const PATCH_ID='2026-08-10-v44-whpp-fast-ui-inject-v1';
...
function html(req,res,next){
  ...
  try{
    ...
    const injected=source.replace('</body>','  <script src="/whpp-v42.js?v=20260810-2"></script>\n  <script src="/whpp-v44.js?v=20260810-1"></script>\n</body>');
