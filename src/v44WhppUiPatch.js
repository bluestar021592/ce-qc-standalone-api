...
const PATCH_ID='2026-08-14-v123-responsive-performance-spine-v14';
...
let installed=false;
express.application.use=function v123WhppUiUse(...args){
...
export function inspectV123HtmlCache(){return {built:Boolean(injectedHtml),bytes:Buffer.byteLength(injectedHtml||'','utf8'),patchId:PATCH_ID};}
