...
const PATCH_ID='2026-08-11-v49-dashboard-correctness-ui-inject-v9';
...
express.application.use=function v44WhppUiUse(...args){
  ...
  if(!installed&&candidates.some(fn=>fn.name==='serveStatic')){
    installed=true;
    // Register before express.static so /whpp and all business dashboards receive
    // the final UI/correctness patches without changing the locked base geometry.
