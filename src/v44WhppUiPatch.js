...
const PATCH_ID='2026-08-17-v172-whpp-dashboard-drilldown-parity-v2+v170-route-isolation+v169-status-sync+v168-truth+v166-performance';
...
let installed=false;
express.application.use=function v172WhppDashboardParityUse(...args){
