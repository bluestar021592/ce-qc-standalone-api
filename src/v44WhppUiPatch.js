...
import './v136CcslForegroundDailyPatch.js';
import './v136ShopeeForegroundDailyPatch.js';
import './v137TrendTruthPatch.js';
import './v137ClassificationAuditPatch.js';
import './v139InstantBootstrapPatch.js';
import './v143HomeTruthPatch.js';

const LEGACY_GATE_MARKERS='v135-whpp-partial-snapshot-v23 v134-whpp-run-supervisor-v21 v137-system-truth-v26 v138-dashboard-speed-trends-v27 v56-trend-truth.js v137-range-trends.js?v=20260815-1 v137-range-trends.js?v=20260815-2 v137-range-trends.js?v=20260815-5 v132-whpp-seven-business-fast.js?v=20260814-2 v139-normal-web-runtime.js?v=20260815-2 v139-normal-web-runtime.js?v=20260815-5';
const PATCH_ID='2026-08-15-v155-classification-first-import-v42';
process.env.CE_QC_UI_BUILD_ID=PATCH_ID;
...
let installed=false;
express.application.use=function v155SystemTruthUiUse(...args){
...
export function inspectV137HtmlCache(){return {built:Boolean(injectedHtml),bytes:Buffer.byteLength(injectedHtml||'','utf8'),patchId:PATCH_ID};}
