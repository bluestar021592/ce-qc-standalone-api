...
const PATCH_ID='2026-08-14-v132-whpp-fast-seven-business-v19';
...
let installed=false;
express.application.use=function v132WhppUiUse(...args){
...
export function inspectV132HtmlCache(){return {built:Boolean(injectedHtml),bytes:Buffer.byteLength(injectedHtml||'','utf8'),patchId:PATCH_ID};}
