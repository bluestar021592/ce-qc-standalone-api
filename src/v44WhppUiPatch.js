...
const PATCH_ID='2026-08-11-v48-routing-ui-inject-v7';
...
express.application.use=function v44WhppUiUse(...args){
  ...
  if(!installed&&candidates.some(fn=>fn.name==='serveStatic')){
    installed=true;
    // Register before express.static so /whpp and the business dashboards receive
    // the final UI patches without changing the locked base index.html geometry.
