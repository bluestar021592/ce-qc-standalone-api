...
const PATCH_ID='2026-08-14-v120-responsive-performance-spine-v13';
...
let installed=false;
express.application.use=function v120WhppUiUse(...args){
...
export function inspectV120HtmlCache(){return {built:Boolean(injectedHtml),bytes:Buffer.byteLength(injectedHtml||'','utf8'),patchId:PATCH_ID};}
