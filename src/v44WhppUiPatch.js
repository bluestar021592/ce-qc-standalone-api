...
const PATCH_ID='2026-08-11-v54-whpp-unified-ui-inject-v15';
...
express.application.use=function v44WhppUiUse(...args){
  ...
  if(!installed&&candidates.some(fn=>fn.name==='serveStatic')){
    installed=true;
    // Register before express.static so every dashboard and the unified import
    // page receive the final WHPP source-truth and one-click integration layers.
