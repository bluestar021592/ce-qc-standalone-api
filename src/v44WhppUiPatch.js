...
const PATCH_ID='2026-08-17-v177-one-business-one-workbook-ui-shell-v1';
...
let installed=false;
express.application.use=function v177OneWorkbookUiUse(...args){
...
export function inspectV177HtmlCache(){return {built:Boolean(injectedHtml),bytes:Buffer.byteLength(injectedHtml||'','utf8'),patchId:PATCH_ID};}
