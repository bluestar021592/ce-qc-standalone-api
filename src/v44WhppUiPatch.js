...
let installed=false;
express.application.use=function v136CurrentDayRuntimeUiUse(...args){
...
export function inspectV136HtmlCache(){return {built:Boolean(injectedHtml),bytes:Buffer.byteLength(injectedHtml||'','utf8'),patchId:PATCH_ID};}
