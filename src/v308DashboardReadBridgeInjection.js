...
export const V308_DASHBOARD_READ_BRIDGE_UI_ID='2026-08-26-v324-auto-full-uploaded-history-bridge-v2';
const MARKER='/v308-dashboard-read-bridge.js?v=20260826-v324-2';
...
console.info('[CE-QC][V324_UI_INJECTION]',V308_DASHBOARD_READ_BRIDGE_UI_ID,'Shopee history table auto-loads all persisted uploaded dates through the selected day while current cards remain exact-day fast; incomplete historical facts stay unknown.');
