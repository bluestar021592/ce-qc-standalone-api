...
export const V231_METRIC_TRUTH_UI_INJECTION_ID = '2026-08-23-v263-canonical-dashboard-delivery-v1';
export const V232_FAST_METRIC_UI_INJECTION_ID = '2026-08-22-v238-retired-fast-metric-ui-v1';
export const V235_CACHE_READY_UI_INJECTION_ID = '2026-08-23-v263-canonical-dashboard-delivery-v1';
...
export const V247_HOME_LEDGER_UI_INJECTION_ID = '2026-08-23-v263-retired-home-attempt-overlay-v1';
export const V249_WHPP_DETAIL_UI_INJECTION_ID = '2026-08-23-v249-whpp-exact-drilldown-ui-v1';
export const V250_SHOPEE_METRIC_VISIBILITY_UI_INJECTION_ID = '2026-08-23-v263-retired-overlay-v1';
export const V251_SHOPEE_FINAL_UI_INJECTION_ID = V250_SHOPEE_METRIC_VISIBILITY_UI_INJECTION_ID;
export const V252_LIFECYCLE_UI_INJECTION_ID = '2026-08-23-v263-retired-visual-overlay-v1';
...
void LEGACY_GATE_V248_MARKER; void LEGACY_GATE_V251_MARKER; void LEGACY_GATE_V254_MARKER; void LEGACY_GATE_V261_MARKER;
...
function prepareOwnerHtml(body) {
  // Remove every historical dashboard/trend overlay. V263 makes the base
  // DashboardV18.renderBusiness path the only visible trend owner.
  for (const file of [
    'v230-metric-truth-ui.js','v232-card-percentages.js','v235-cache-ready-reload.js',
...
express.response.send = function v263MetricTruthUiSend(body) {
  if (typeof body === 'string' && body.includes('</body>') && body.includes('CE Express')) {
    ...
    this.setHeader?.('X-CE-QC-V263-UI', V231_METRIC_TRUTH_UI_INJECTION_ID);
  }
  return originalSend.call(this, body);
};

console.info('[CE-QC][V263_CANONICAL_DASHBOARD]', V231_METRIC_TRUTH_UI_INJECTION_ID, 'legacy visual overlays retired; DashboardV18 is the single visible owner; attempt/signing UI limited to TBKH + SHOPEECN + SHOPEEVN');
