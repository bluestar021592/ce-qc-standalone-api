...
export const V235_CACHE_READY_UI_INJECTION_ID = '2026-08-22-v237-dashboard-owner-ui-injection-v3';
...
const HOME_MARKER = '/v237-home-dashboard-owner.js?v=20260822-v237-2';
...
console.info('[CE-QC][V237_DASHBOARD_OWNER_UI]', V235_CACHE_READY_UI_INJECTION_ID, 'head-first owner guard + single live trend table + homepage owner enabled; V230/V232 retired');
