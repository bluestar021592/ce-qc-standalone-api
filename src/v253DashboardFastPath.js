...
function whppCount(date,db=getDb()){
  ...
  let count=0,expected=null,actual=0,membershipSource='NO_SAFE_WHPP_MEMBERSHIP',incomplete=false;
  if(daily){
    ...
    else{count=0;membershipSource='WHPP_STANDARD_DAILY_INCOMPLETE_FAIL_CLOSED';incomplete=true;}
  }else{
