...
export const V295_FIRST_ATTEMPT_UI_INJECTION_ID='2026-08-26-v317-ccsl-restart-recovery-injection-v1';
...
const V317_CCSL_RECOVERY_MARKER='/v317-ccsl-recovery-owner.js?v=20260826-v317-1';
...
express.response.send=function v295FirstAttemptUiSend(body){
  if(typeof body==='string'&&body.includes('</body>')&&body.includes('CE Express')){
    ...
    this.setHeader?.('X-CE-QC-V317-UI','2026-08-26-v317-ccsl-restart-auto-recovery-v1');
  }
  return originalSend.call(this,body);
};
console.info('[CE-QC][V317_UI_INJECTION]',V295_FIRST_ATTEMPT_UI_INJECTION_ID,'V313 remains canonical SHOPEE completion owner; V317 adds independent CCSL restart recovery from persisted current-day membership/checkpoints and respects explicit pause.');