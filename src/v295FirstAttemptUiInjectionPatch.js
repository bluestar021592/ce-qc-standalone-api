...
export const V295_FIRST_ATTEMPT_UI_INJECTION_ID='2026-08-26-v328-three-business-history-injection-v1';
...
const V320_HISTORY_TREND_MARKER='/v320-history-trend-owner.js?v=20260826-v328-1';
const V328_ATTEMPT_MARKER='/v328-three-business-attempt-owner.js?v=20260826-v328-1';
...
express.response.send=function v328FirstAttemptUiSend(body){
  if(typeof body==='string'&&body.includes('</body>')&&body.includes('CE Express')){
    ...
    this.setHeader?.('X-CE-QC-V320-UI','2026-08-26-v328-three-business-shared-history-trend-ui-v1');
...
console.info('[CE-QC][V328_UI_INJECTION]',V295_FIRST_ATTEMPT_UI_INJECTION_ID,'V325 stable home retained; TBKH + Shopee CN/VN history, dispatch→POD trend, and 1/2/3 attempt trend now share the V328 payload.');
