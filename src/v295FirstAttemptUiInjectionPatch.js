...
export const V295_FIRST_ATTEMPT_UI_INJECTION_ID='2026-08-26-v311-backend-aware-shopee-recovery-injection-v1';
...
const V311_RECOVERY_MARKER='/v311-shopee-recovery-owner.js?v=20260826-v311-1';
...
console.info('[CE-QC][V311_UI_INJECTION]',V295_FIRST_ATTEMPT_UI_INJECTION_ID,'V311 backend-aware recovery runs after V310 and reopens only finished-without-valid-snapshot SHOPEE runs; prior exact-truth owners remain intact.');
