...
test('V165 browser asset is cache-busted by the injected application shell', () => {
  assert.match(uiPatch, /v67-resilient-run-guard\.js\?v=20260817-1/);
  assert.match(uiPatch, /v165-seven-business-stage-verification-v2/);
  assert.doesNotMatch(uiPatch, /v148-direct-daily-runner-v1/);
});
